...
public class OneAndHalfCubeBumpEngage extends SequentialCommandGroup {

    public OneAndHalfCubeBumpEngage(DriveTrain driveTrain, Intake intake, Elevator elevator, Arm arm) {
        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                ...
                new TurnToNAngleCmd(Units.degreesToRadians(0), driveTrain),
                // drives a little to line up with charging station
                new DriveStraightGivenDistance(0.5, 1.25, driveTrain),
                new IntakeForGivenTime(intake, IntakeConstants.CUBE_IN_SPEED, 0.5),
                new InstantCommand(() -> {RobotContainer.coneMode = false;})
            ),
            // Turns right 90 degrees to face charging station 
            new TurnToNAngleCmd(Units.degreesToRadians(0), driveTrain),
            // Drives on charging station
