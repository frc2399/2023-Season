...
public class OneAndHalfConeNoEngage extends SequentialCommandGroup {

    public OneAndHalfConeNoEngage(DriveTrain driveTrain, Intake intake, Elevator elevator, Arm arm) {
